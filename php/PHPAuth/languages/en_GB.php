...
$lang['email_activation_body'] = 'Hello,<br/><br/> To be able to log in to your Walkspan account you first need to activate your account by entering an activation key at senseofwalk.com or the Walkspan mobile app. Use the following activation key: <strong>%3$s</strong><br/><br/> If you did not sign up for a Walkspan account recently then this message was sent in error, please ignore it.';
